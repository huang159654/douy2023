...
class List_video(): #
    ...
    def get_count(self, next='max_cursor=0'):
        ...
        params = f'device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=MS4wLjABAAAAcMKl7JekBXRprjAc9nT8EFEvSzgK_qfToMmfnnPCHQc&{next}&locate_query=false&show_live_replay_strategy=1&need_time_list=1&time_list_query=0&whale_cut_token=&cut_version=1&count=18&publish_video_strategy_type=2&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1707&screen_height=1067&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=119.0.0.0&browser_online=true&engine_name=Blink&engine_version=119.0.0.0&os_name=Windows&os_version=10&cpu_core_num=16&device_memory=8&platform=PC&downlink=7.9&effective_type=4g&round_trip_time=50&webid=7310230678028846631&msToken=XWdh8ZPfrgSs9QombFXY3DJxXhH3HTyjw7NtYb6tpW9wYpaZqIAuhcZmOtQBu-7qgnSFswVdEZ2cKWsg6A4_WkxwyxIH3CCuMoLOUh4H6iqGBk7-ba8jaBufrmt2jw=='
        print(f'正在打印{next}')
        ...
        if response['max_cursor'] != 0:
            ...
            for data_list in response['aweme_list']:
                ...
                # with open(
                #         r'C:\Users\Administrator\PycharmProjects\pythonProject\函数\抖音\抖音js\video\\' + title + '.mp4',
                #         mode='wb') as f:
                #     # 写入数据
